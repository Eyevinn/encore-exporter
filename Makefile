...
example:
	go build -ldflags "-X github.com/Eyevinn/encore-exporter/internal.commitVersion=$$(git describe --tags HEAD) -X github.com/Eyevinn/encore-exporter/internal.commitDate=$$(git log -1 --format=%ct)" -o out/$@ ./cmd/$@/main.go
